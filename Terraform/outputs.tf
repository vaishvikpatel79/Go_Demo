...
output "frontend_ecr_image_uri" {
  description = "Amazon ECR image URI for the Frontend image (includes tag from service_tags)"
  value       = local.service_images["frontend-service"]
}

output "backend_ecr_image_uri" {
  description = "Amazon ECR image URI for the Backend image (includes tag from service_tags)"
...
output "deployment_contract" {
  description = "Deployment contract for the deployment agent"
  value = {
    meta = {
