...
output "frontend_ecs_service_name" {
  ...
  value       = aws_ecs_service.go-demo-frontend-service.name
}

output "backend_ecs_service_name" {
  description = "Name of the Backend ECS Service"
  value       = aws_ecs_service.go-demo-backend-service.name
}

output "frontend_task_definition_arn" {
  description = "ARN of the Frontend Task Definition"
  value       = aws_ecs_task_definition.frontend-task.arn
}

output "backend_task_definition_arn" {
  description = "ARN of the Backend Task Definition"
  value       = aws_ecs_task_definition.backend-task.arn
}

output "frontend_ecr_repository_uri" {
  description = "Amazon ECR Repository URI for the Frontend image"
  value       = "${var.account_id}.dkr.ecr.${var.region}.amazonaws.com/${var.service_repositories["go-demo-frontend-service"]}"
}

output "backend_ecr_repository_uri" {
  description = "Amazon ECR Repository URI for the Backend image"
  value       = "${var.account_id}.dkr.ecr.${var.region}.amazonaws.com/${var.service_repositories["go-demo-backend-service"]}"
}
...
output "deployment_contract" {
  value = {
    ...
    compute = {
      ...
      service_name = null
      service_names = {
        "go-demo-frontend-service" = aws_ecs_service.go-demo-frontend-service.name
        "go-demo-backend-service"  = aws_ecs_service.go-demo-backend-service.name
      }
      task_family   = null
      workload_name = null
    }
