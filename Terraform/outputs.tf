...
output "frontend_ecr_image_uri" {
  description = "Amazon ECR image URI for the Frontend image (constructed with tag)."
  value       = local.service_images["frontend-service"]
}

output "backend_ecr_image_uri" {
  description = "Amazon ECR image URI for the Backend image (constructed with tag)."
